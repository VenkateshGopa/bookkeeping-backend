...
const services = {
  ...
  register: async (req, res) => {
    try{
      ...
      <p>https://nervous-poitras-54f763.netlify.app/active/${registereduser.insertedId}</p>`, <p>Activate yout book keeping Account</p>);
  ...
  forgotpassword: async(req, res) => {
    try{
      ...
      <P>(or) Use the below link</p>
      <p>https://nervous-poitras-54f763.netlify.app/${user._id}/${code}</p>`, <p>Reset password </p>);
